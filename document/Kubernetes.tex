% TODO: Initialisierung Cluster mit Minikube beschreiben
...
% TODO: Abschnitt ergänzen. Wichtig um klarzustellen, wie Pods über internes Netzwerk kommunizieren
...
% Im Produktivumfeld müsste FastAPI besser gesichert werden
% Autoscaling (oder noch als TODO implementieren)
% Evtl. Flaschenhals durch Datenbankanwendungen (schwer replizierbar)
% Hohe Komplexität von Kubernetes --> Anwendung muss gerechtfertigt sein
\section{Ausblick}
% Frontend um weitere Funktionen ergänzen (z.B. Nutzerfeedback für Eingaben)
...
% Testcases
% CI/CD \cite{Schmeling_Dargatz_2022} Kap. 3 beschreibt, wie man Kubernetes verwenden kann, um die Entwicklung von Anwendungen zu beschleunigen
% Generell Zukunft von Kubernetes
% Speicherverwaltung über mehrere Nodes hinweg
\section{Anhang}
