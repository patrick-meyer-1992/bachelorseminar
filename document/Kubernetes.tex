...
% TODO: Begriffe Applikation und Anwendung vereinheitlichen
% TODO: Code Listings mit Quelle versehen
...
\cite{Pagani_2019} % TODO: Wenn möglich bessere Quelle als Pagani_2019 finden
...
% TODO: Eventuell Absatz dazu wie Schmeling_Dargatz_2022 diese Umgebungen aufteilen würden (S. 249 ff.)
...
% S.138
% Ziel: Code produktiv bekommen
% Entwickler wollen sich auf Entwickeln konzentrieren
% Unterschiedliche Entwickler nutzen unterschiedliche Programmiersprachen

% S.139
% Innerer Loop als erste Phase der Entwicklung.
% Entwickler meist sehr effizient darin, in ihrem eigenen inner Loop zu arbeiten

% S.140
% Kubernetes hat keinen Fokus auf Unterstützung der Softwareentwicklung (sondern running container applications)

% S.145
% Hot reloading in klassischer Softwareentwicklung (Beispiel Angular)

% S.146 - 147
% Tabelle zeigt Vor- und Nachteile lokaler Entwicklung

% S. 148
% Fremde Komponenten, die für die Entwicklung an der eigenen Komponente wichtig sind, können einfach über ein Dockerfile definiert werden

% S.150
% Dockerfile für die eigene Anwendung kann erstellt werden

% S.151
% Hauptproblem: Hot Reloading. Kann aber dadurch gelöst werden, dass man den Ordner mit dem Quellcode als Volume einbindet

% S.157 - 159
% Vor- und Nachteile wenn man Container in der Entwicklung nutzt

% S.160
% Lücke zwischen Entwicklung und Produktion soll möglichst klein gehalten werden
% Auch wenn Code auf Kubernetes ausgeführt und sogar entwickelt wird, bleibt noch eine Lücke
% Kubernetes ist über verschiedene Plattformen hinweg gleich.

% S.161
% Loakles Minikube oder development cluster hat zwar nicht die Ressourcen von Prod, kann aber schon helfen, Fehler zu entdecken, die nichts mit der
...
% \cite{cicd_with_kubernetes}
% S. 12 Was ist DevOps und was ist die Historie
% Hochspezialisierte Server mit viel Konfigurationsaufwand (früher). Dann ersetzt durch Docker. Weniger Anforderungen an Hardwareserver

% S. 254
% Einzelne Schritte von Pipeline
% \cite{Schmeling_Dargatz_2022} Verschiedene Umgebungen können unterschiedlich realisiert werden (Namespaces, Cluster)
% Der Container wird getestet, nicht der Source Code, da Fehler zwischen Sourcecode und Binary auftreten können
% verschiedene Tools für CI CD <-- evtl Gitlab und Github hervorheben

% S. 266
% GitOps als Infrastructure as Code

% S. 269
% GitOps Tools können automatisch ein Deployment triggern, wenn Änderungen an den Kubernetes Manifesten
% oder am Helm Chart festgestellt werden
% Alles was nicht im Git repo ist, wird automatisch zurückgerollt (z.B. manuelle Änderungen)
% Alle Änderungen werden im Git Repo getrackt. Ermöglicht Dokumentation und Nachvollziehbarkeit
...
in eine Cloud-Umgebung migriert werden können. Als Cloud Umgebung wurde AWS, % TODO: AWS erklären
...
zu Google Cloud. Spotify entschied sich, zukünftig Kubernetes zur Container-Orchestrierung zu nutzen, % TODO: Google Cloud erklären
...
% Ursprünglich überwiegend Baremetal auf eigener Hardware
% Monolithische PHP Code Basis
% Global Expandierende Firma hatte Bedarf, Workload über verschiedene Cloud Infrastrukturen zu nutzen
% Früher mehr als 6 Monate um einen neuen Microservice auszubringen. Mittlerweile weniger als 5 Tage.
% 2014 knapp 10 Jahre Soft- und Hardware, die nicht mehr auf Stand war.
% Kubernetes bietet einheitliche API (über verschiedene Cloudplattformen und Bare Metal), um neue Werkzeuge danach auszurichten
% Services nach und nach migriert
% Mehrere hundert Nodes

% \subsection{BlaBlaCar}
% Langstrecken Car Pooling
% gegründet 2006

% 40 Millionen Nutzer in 22 Ländern
% Starkes Wachstum seit 2012
% 2015 50 bare Metal Server
% Kubernetes ermöglicht Entwicklern sich auf die Entwicklung zu konzentrieren (Features)
% Nutzen rkt als Container Engine (statt Docker)
% Bis Dezember 2015 sollte die gesamte Plattform containerisiert werden (bis dahin zu 80\% gelungen, mittlerweile 100\%)
% Schnelleres Ausbringen von Services
% Mittlerweile 3000 Pods, davon 1200 eingebunden in Kubernetes
...
% - Nachteile von Microservices, die sich auch auf Kubernetes auswirken (Komplexere Entwicklung, schwieriger testen im Vergleich zu Monolith, Quelle: 8406008)
...
% - Will Kubernetes disappear? domingus2022cloud, S.13
% - Schmeling und Dargatz gehen davon aus, dass Kubernetes "Standard" wird  und viele bestehende Tools dafür optimiert werden S.1 
