...
\lstinputlisting[caption={Beispielhafte Konfiguration eines Pods in YAML.}, label=lst:pod-config]{../kubernetes/nginx/pod.yaml}
...
\lstinputlisting[caption={Beispielhafte Konfiguration eines ReplicaSets mit drei Pods in YAML}, label=lst:rs-config]{../kubernetes/nginx/replicaset.yaml}
...
\lstinputlisting[caption={Beispielhafte Konfiguration eines Service in YAML.}, label=lst:svc-config]{../kubernetes/nginx/service.yaml}
...
\lstinputlisting[caption={Beispielhafte Konfiguration eines Ingress in YAML.}, label=lst:ingress-config]{../kubernetes/nginx/ingress.yaml}
...
\lstinputlisting[caption={Beispielhafte Konfiguration eines Persistent Volume in YAML.}, label=lst:pv]{../kubernetes/nginx/pv.yaml}
\lstinputlisting[caption={Beispielhafte Konfiguration eines Persistent Volume Claims in YAML.}, label=lst:pvc]{../kubernetes/nginx/pvc.yaml}
\lstinputlisting[caption={Auszug aus einer beispielhaften Konfiguration eines Deployments, das ein Persistent Volume Claims einbindet.}, label=lst:deploy-pvc]{../kubernetes/nginx/pvc-deployment.yaml}
...
\lstinputlisting[caption={Beispielhafte Konfiguration einer ConfigMap in YAML.}, label=lst:config]{../kubernetes/nginx/config.yaml}
...
\lstinputlisting[caption={Beispielhafte Konfiguration eines Secrets in YAML.}, label=lst:secret]{../kubernetes/nginx/secret-example.yaml}
