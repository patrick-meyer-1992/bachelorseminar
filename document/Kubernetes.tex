...
können sie auch unabhängig von anderen Containern repliziert werden. Näheres zu Containern wird im Abschnitt
\ref{sec:Container} behandelt.

Um eine vollständige Anwendung zu erhalten, betreibt man  oft mehrere Container, die im Verbund zusammenwirken; eine sogenannte Microservice-Architektur. 
...
Für viele populäre Anwendungen (z.B. nginx, Ubuntu oder Node.js) gibt es vorgefertigte Images, die kostenfrei vom DockerHub % Quelle ergänzen
